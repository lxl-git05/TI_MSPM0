...
{
    float err  = fabsf(targetYaw - ICM_Mahony_Real.yaw);
    float gyro = fabsf(ICM_Raw_Data.GZ - ICM_Mahony_GyroBiasZ);   // 去零偏后的角速度
...
{
    return ICM42688_Turn_Yaw_Is_Ok_Ex(targetYaw, 5.0f, 7.0f);
}
